function errorHandler(asyncController) {
    return async (req, res) => {
        try {
            ...
            else if (err.message === "USER_NOT_EXIST" || "INVALID_PASSWORD" || "USER_NOT_EXIST" || "INVALID_NAME" || "INVALID_BIRTH" || "INVALID_PHONE_NUMBER" || "INVALID_PASSWORD" || "INVALID_USER_ID" || "INVALID_EMAIL")
